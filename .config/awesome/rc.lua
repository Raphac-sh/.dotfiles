...
local volume_widget_widget = volume_widget({display_notification = false})
...
local theme_path = string.format("~/.config/awesome/%s/theme.lua", "default")
...
awful.rules.rules = {
    ...
    -- Add titlebars to normal clients and dialogs
        ...
        { rule = { class = "Firefox" },
         properties = { tag = "www", border_width = beautiful.border_width} },
